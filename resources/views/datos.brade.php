        ...
        <form action="{{ route('enviarCodigo') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="alcaldia" name="alcaldia" placeholder="Alcaldía / Municipio" required>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="entreCalle1" name="entreCalle1" placeholder="Entre calle 1">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="entreCalle2" name="entreCalle2" placeholder="Entre calle 2">
                </div>
                <div class="col-md-6 mb-3">
